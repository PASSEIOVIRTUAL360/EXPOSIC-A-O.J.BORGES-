...
// Pano2VR 7.1.9/20995
// Filename: dsfsdf.ggsk
// Generated 2025-08-08T07:09:55
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('category_visible_1', 2, false, { ignoreInState: 1  });
	...
	this.addSkin=function() {
		...
		me._node_scroller.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('menu_cloner') == Number("2")))
			)
			{
				newLogicStateAlpha = 0;
			}
		...
		el.isDragging = function() {
			let scrollerParent = me._node_cloner0;
		...
		el.ggUpdate = function(filter) {
			...
			var centerOffsetVert = 0;
				me._node_cloner0.ggCloneOffsetChanged = false;
			}
			...
			tourNodes = me._node_cloner0.getFilteredNodes(tourNodes, filter);
			me._node_cloner0.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me._node_cloner0.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me._node_cloner0.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me._node_cloner0.ggWidth) + 'px';
			...
			me._node_cloner0.ggNodeCount = me._node_cloner0.ggNumFilterPassed;
			me._node_cloner0.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me._node_cloner0.parentNode && me._node_cloner0.parentNode.classList.contains('ggskin_subelement') && me._node_cloner0.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me._node_cloner0.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "_nop_";
		el.ggId="node_cloner";
		...
		me._node_scroller__content.appendChild(me._node_cloner0);
		me._menu_background.appendChild(me._node_scroller);
		el=me._category_2_scroller=document.createElement('div');
		els=me._category_2_scroller__content=document.createElement('div');
		els.className='ggskin ggskin_subelement ggskin_scrollarea';
		el.ggContent=els;
		el.appendChild(els);
		el.ggHorScrollVisible = false;
		...
		hs+="";
		els.setAttribute('style',hs);
		me._category_2_scroller.ggScrollByX = function(diffX) {
			if(!me._category_2_scroller.ggHorScrollVisible || diffX == 0 || me._category_2_scroller.ggHPercentVisible >= 1.0) return;
			me._category_2_scroller.ggScrollPosX = (me._category_2_scroller__horScrollFg.offsetLeft + diffX);
			me._category_2_scroller.ggScrollPosX = Math.max(me._category_2_scroller.ggScrollPosX, 0);
			me._category_2_scroller.ggScrollPosX = Math.min(me._category_2_scroller.ggScrollPosX, me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth);
			me._category_2_scroller__horScrollFg.style.left = me._category_2_scroller.ggScrollPosX + 'px';
			let percentScrolled = me._category_2_scroller.ggScrollPosX / (me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth);
			me._category_2_scroller__content.style.left = -(Math.round((me._category_2_scroller.ggContentWidth * (1.0 - me._category_2_scroller.ggHPercentVisible)) * percentScrolled)) + me._category_2_scroller.ggContentLeftOffset + 'px';
			me._category_2_scroller.ggScrollPosXPercent = (me._category_2_scroller__horScrollFg.offsetLeft / me._category_2_scroller__horScrollBg.offsetWidth);
		}
		me._category_2_scroller.ggScrollByXSmooth = function(diffX) {
			if(!me._category_2_scroller.ggHorScrollVisible || diffX == 0 || me._category_2_scroller.ggHPercentVisible >= 1.0) return;
			var scrollPerInterval = diffX / 25;
			var scrollCurrX = 0;
			var id = setInterval(function() {
				scrollCurrX += scrollPerInterval;
				me._category_2_scroller.ggScrollPosX += scrollPerInterval;
				if (diffX > 0 && (scrollCurrX >= diffX || me._category_2_scroller.ggScrollPosX >= me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth)) {
					me._category_2_scroller.ggScrollPosX = Math.min(me._category_2_scroller.ggScrollPosX, me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth);
					clearInterval(id);
				}
				if (diffX < 0 && (scrollCurrX <= diffX || me._category_2_scroller.ggScrollPosX <= 0)) {
					me._category_2_scroller.ggScrollPosX = Math.max(me._category_2_scroller.ggScrollPosX, 0);
					clearInterval(id);
				}
			me._category_2_scroller__horScrollFg.style.left = me._category_2_scroller.ggScrollPosX + 'px';
		...
		me._category_2_scroller.ggScrollByY = function(diffY) {
			if(!me._category_2_scroller.ggVertScrollVisible || diffY == 0 || me._category_2_scroller.ggVPercentVisible >= 1.0) return;
			me._category_2_scroller.ggScrollPosY = (me._category_2_scroller__vertScrollFg.offsetTop + diffY);
			me._category_2_scroller.ggScrollPosY = Math.max(me._category_2_scroller.ggScrollPosY, 0);
			me._category_2_scroller.ggScrollPosY = Math.min(me._category_2_scroller.ggScrollPosY, me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight);
			me._category_2_scroller__vertScrollFg.style.top = me._category_2_scroller.ggScrollPosY + 'px';
			let percentScrolled = me._category_2_scroller.ggScrollPosY / (me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight);
			me._category_2_scroller__content.style.top = -(Math.round((me._category_2_scroller.ggContentHeight * (1.0 - me._category_2_scroller.ggVPercentVisible)) * percentScrolled)) + me._category_2_scroller.ggContentTopOffset + 'px';
			me._category_2_scroller.ggScrollPosYPercent = (me._category_2_scroller__vertScrollFg.offsetTop / me._category_2_scroller__vertScrollBg.offsetHeight);
		}
		me._category_2_scroller.ggScrollByYSmooth = function(diffY) {
			if(!me._category_2_scroller.ggVertScrollVisible || diffY == 0 || me._category_2_scroller.ggVPercentVisible >= 1.0) return;
			var scrollPerInterval = diffY / 25;
			var scrollCurrY = 0;
			var id = setInterval(function() {
				scrollCurrY += scrollPerInterval;
				me._category_2_scroller.ggScrollPosY += scrollPerInterval;
				if (diffY > 0 && (scrollCurrY >= diffY || me._category_2_scroller.ggScrollPosY >= me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight)) {
					me._category_2_scroller.ggScrollPosY = Math.min(me._category_2_scroller.ggScrollPosY, me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight);
					clearInterval(id);
				}
				if (diffY < 0 && (scrollCurrY <= diffY || me._category_2_scroller.ggScrollPosY <= 0)) {
					me._category_2_scroller.ggScrollPosY = Math.max(me._category_2_scroller.ggScrollPosY, 0);
					clearInterval(id);
				}
			me._category_2_scroller__vertScrollFg.style.top = me._category_2_scroller.ggScrollPosY + 'px';
		...
		me._category_2_scroller.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._category_2_scroller.ggHorScrollVisible) {
				if (posX < 0) {
					var diffX = Math.floor(posX * me._category_2_scroller.ggHPercentVisible);
					me._category_2_scroller.ggScrollByXSmooth(diffX);
				} else if (posX + width > me._category_2_scroller.clientWidth - (me._category_2_scroller.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._category_2_scroller.clientWidth - (me._category_2_scroller.ggVertScrollVisible ? 15 : 0))) * me._category_2_scroller.ggHPercentVisible);
					me._category_2_scroller.ggScrollByXSmooth(diffX);
				}
			}
			if (me._category_2_scroller.ggVertScrollVisible) {
				if (posY < 0) {
					var diffY = Math.floor(posY * me._category_2_scroller.ggVPercentVisible);
					me._category_2_scroller.ggScrollByYSmooth(diffY);
				} else if (posY + height > me._category_2_scroller.clientHeight - (me._category_2_scroller.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._category_2_scroller.clientHeight - (me._category_2_scroller.ggHorScrollVisible ? 15 : 0))) * me._category_2_scroller.ggVPercentVisible);
					me._category_2_scroller.ggScrollByYSmooth(diffY);
				}
			}
		}
		me._category_2_scroller__content.mousetouchend = e => {
			let inertiaInterval = setInterval(function() {
				me._category_2_scroller.ggDragInertiaX *= 0.96;
				me._category_2_scroller.ggDragInertiaY *= 0.96;
				me._category_2_scroller.ggScrollByX(me._category_2_scroller.ggDragInertiaX);
				me._category_2_scroller.ggScrollByY(me._category_2_scroller.ggDragInertiaY);
				if (Math.abs(me._category_2_scroller.ggDragInertiaX) < 1.0 && Math.abs(me._category_2_scroller.ggDragInertiaY) < 1.0) {
					clearInterval(inertiaInterval);
				}
				}, 10);
			me._category_2_scroller__content.onmouseup = null;
			me._category_2_scroller__content.onmousemove = null;
			me._category_2_scroller__content.ontouchend = null;
			me._category_2_scroller__content.ontouchmove = null;
			me._category_2_scroller__content.onpointerup = null;
			me._category_2_scroller__content.onpointermove = null;
			setTimeout(function() { me._category_2_scroller.ggIsDragging = false; }, 100);
		}
		me._category_2_scroller__content.mousetouchmove = e => {
			e = e || window.event;
			e.preventDefault();
			var t = e.touches;
			var eventX = t ? t[0].clientX : e.clientX;
			var eventY = t ? t[0].clientY : e.clientY;
			if (Math.abs(eventX - me._category_2_scroller.ggDragStartX) > 10 || Math.abs(eventY - me._category_2_scroller.ggDragStartY) > 10) me._category_2_scroller.ggIsDragging = true;
			var diffX = (eventX - me._category_2_scroller.ggDragLastX) * me._category_2_scroller.ggHPercentVisible;
			var diffY = (eventY - me._category_2_scroller.ggDragLastY) * me._category_2_scroller.ggVPercentVisible;
			me._category_2_scroller.ggDragInertiaX = -diffX;
			me._category_2_scroller.ggDragInertiaY = -diffY;
			me._category_2_scroller.ggDragLastX = eventX;
			me._category_2_scroller.ggDragLastY = eventY;
			me._category_2_scroller.ggScrollByX(-diffX);
			me._category_2_scroller.ggScrollByY(-diffY);
		}
		me._category_2_scroller__content.mousetouchstart = e => {
			e = e || window.event;
			var t = e.touches;
			me._category_2_scroller.ggDragLastX = me._category_2_scroller.ggDragStartX = t ? t[0].clientX : e.clientX;
			me._category_2_scroller.ggDragLastY = me._category_2_scroller.ggDragStartY = t ? t[0].clientY : e.clientY;
			me._category_2_scroller__content.onmouseup = me._category_2_scroller__content.mousetouchend;
			me._category_2_scroller__content.ontouchend = me._category_2_scroller__content.mousetouchend;
			me._category_2_scroller__content.onmousemove = me._category_2_scroller__content.mousetouchmove;
			me._category_2_scroller__content.ontouchmove = me._category_2_scroller__content.mousetouchmove;
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._category_2_scroller__content.onpointerup = me._category_2_scroller__content.ontouchend;
				me._category_2_scroller__content.onpointermove = me._category_2_scroller__content.ontouchmove;
			}
		}
		els.onmousedown = me._category_2_scroller__content.mousetouchstart;
		els.ontouchstart = me._category_2_scroller__content.mousetouchstart;
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			els.onpointerdown = me._category_2_scroller__content.mousetouchstart;
		}
		elHorScrollBg = me._category_2_scroller__horScrollBg = document.createElement('div');
		...
		elHorScrollFg = me._category_2_scroller__horScrollFg = document.createElement('div');
		...
		me._category_2_scroller.ggScrollPosX = 0;
		me._category_2_scroller.ggScrollPosXPercent = 0.0;
		elHorScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._category_2_scroller.ggDragLastX = e.clientX;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._category_2_scroller.ggDragInertiaX *= 0.96;
					me._category_2_scroller.ggScrollByX(me._category_2_scroller.ggDragInertiaX);
					if (Math.abs(me._category_2_scroller.ggDragInertiaX) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
				document.onmouseup = null;
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffX = e.clientX - me._category_2_scroller.ggDragLastX;
				me._category_2_scroller.ggDragInertiaX = diffX;
				me._category_2_scroller.ggDragLastX = e.clientX;
				me._category_2_scroller.ggScrollByX(diffX);
			}
		...
		elHorScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._category_2_scroller.ggDragLastX = t ? t[0].clientX : e.clientX;
			document.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._category_2_scroller.ggDragInertiaX *= 0.96;
					me._category_2_scroller.ggScrollByX(me._category_2_scroller.ggDragInertiaX);
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffX = (t ? t[0].clientX : e.clientX) - me._category_2_scroller.ggDragLastX;
				me._category_2_scroller.ggDragInertiaX = diffX;
				me._category_2_scroller.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._category_2_scroller.ggScrollByX(diffX);
			}
		...
		elHorScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffX = me._category_2_scroller.ggScrollWidth;
			if (e.offsetX < me._category_2_scroller.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._category_2_scroller.ggScrollByXSmooth(diffX);
		}
		elHorScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._category_2_scroller__horScrollBg.getBoundingClientRect();
			var diffX = me._category_2_scroller.ggScrollWidth;
			if ((t[0].clientX - rect.left) < me._category_2_scroller.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._category_2_scroller.ggScrollByXSmooth(diffX);
		}
		el.addEventListener('wheel', function(e) {
			...
			me._category_2_scroller.ggScrollByXSmooth(30 * me._category_2_scroller.ggHPercentVisible * wheelDelta);
		});
		elVertScrollBg = me._category_2_scroller__vertScrollBg = document.createElement('div');
		el.appendChild(elVertScrollBg);
		...
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._category_2_scroller__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		...
		elVertScrollFg.className='ggskin ggskin_scrollarea_vscrollfg';
		me._category_2_scroller.ggScrollPosY = 0;
		me._category_2_scroller.ggScrollPosYPercent = 0.0;
		elVertScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._category_2_scroller.ggDragLastY = e.clientY;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._category_2_scroller.ggDragInertiaY *= 0.96;
					me._category_2_scroller.ggScrollByY(me._category_2_scroller.ggDragInertiaY);
					if (Math.abs(me._category_2_scroller.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
				document.onmouseup = null;
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffY = e.clientY - me._category_2_scroller.ggDragLastY;
				me._category_2_scroller.ggDragInertiaY = diffY;
				me._category_2_scroller.ggDragLastY = e.clientY;
				me._category_2_scroller.ggScrollByY(diffY);
			}
		...
		elVertScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._category_2_scroller.ggDragLastY = t ? t[0].clientY : e.clientY;
			document.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._category_2_scroller.ggDragInertiaY *= 0.96;
					me._category_2_scroller.ggScrollByY(me._category_2_scroller.ggDragInertiaY);
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffY = (t ? t[0].clientY : e.clientY) - me._category_2_scroller.ggDragLastY;
				me._category_2_scroller.ggDragInertiaY = diffY;
				me._category_2_scroller.ggDragLastY = t ? t[0].clientY : e.clientY;
				me._category_2_scroller.ggScrollByY(diffY);
			}
		...
		elVertScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffY = me._category_2_scroller.ggScrollHeight;
			if (e.offsetY < me._category_2_scroller.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._category_2_scroller.ggScrollByYSmooth(diffY);
		}
		elVertScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._category_2_scroller__vertScrollBg.getBoundingClientRect();
			var diffY = me._category_2_scroller.ggScrollHeight;
			if ((t[0].clientY - rect.top) < me._category_2_scroller.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._category_2_scroller.ggScrollByYSmooth(diffY);
		}
		el.addEventListener('wheel', function(e) {
			e.preventDefault();
			var wheelDelta = Math.sign(e.deltaY);
			me._category_2_scroller.ggScrollByYSmooth(30 * me._category_2_scroller.ggVPercentVisible * wheelDelta);
		});
		elCornerBg = me._category_2_scroller__cornerBg = document.createElement('div');
		el.appendChild(elCornerBg);
		elCornerBg.setAttribute('style', 'position: absolute; right: 0px; bottom: 0px; visibility: hidden; width: 15px; height: 15px; background-color: rgba(255,255,255,1);');
		elCornerBg.className='ggskin ggskin_scrollarea_scrollcorner';
		el.ggId="category_2_scroller";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_scrollarea ";
		el.ggType='scrollarea';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._category_2_scroller.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._category_2_scroller.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('menu_cloner') == Number("1")))
			)
			{
				newLogicStateAlpha = 0;
			}
			...
			if (me._category_2_scroller.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._category_2_scroller.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._category_2_scroller.style.transition='opacity 500ms ease 0ms';
				if (me._category_2_scroller.ggCurrentLogicStateAlpha == 0) {
					me._category_2_scroller.style.visibility=me._category_2_scroller.ggVisible?'inherit':'hidden';
					me._category_2_scroller.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me._category_2_scroller.style.opacity == 0.0) { me._category_2_scroller.style.visibility="hidden"; } }, 505);
					me._category_2_scroller.style.opacity=0;
				}
			}
		}
		me._category_2_scroller.logicBlock_alpha();
		me._category_2_scroller.ggUpdatePosition=function (useTransition) {
			{
				var horScrollWasVisible = this.ggHorScrollVisible;
				var vertScrollWasVisible = this.ggVertScrollVisible;
				this.ggContent.style.left = '0px';
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				this.ggContentHeight = contentHeight / scaleY;
				this.ggContent.style.left = -(Math.round(me._category_2_scroller.ggScrollPosX / me._category_2_scroller.ggHPercentVisible)) + this.ggContentLeftOffset + 'px';
				this.ggContent.style.marginLeft = '0px';
				this.ggContent.style.top = -(Math.round(me._category_2_scroller.ggScrollPosY / me._category_2_scroller.ggVPercentVisible)) + this.ggContentTopOffset + 'px';
				this.ggContent.style.marginTop = '0px';
				if (contentWidth > Math.ceil(offsetWidthWithScale)) {
					me._category_2_scroller__horScrollBg.style.visibility = 'inherit';
					me._category_2_scroller__horScrollFg.style.visibility = 'inherit';
					me._category_2_scroller.ggHorScrollVisible = true;
				} else {
					me._category_2_scroller__horScrollBg.style.visibility = 'hidden';
					me._category_2_scroller__horScrollFg.style.visibility = 'hidden';
					me._category_2_scroller.ggHorScrollVisible = false;
				}
				if ((me._category_2_scroller.ggHorScrollVisible && contentHeight > this.clientHeight - 15) || (!me._category_2_scroller.ggHorScrollVisible && contentHeight > this.clientHeight)) {
					me._category_2_scroller__vertScrollBg.style.visibility = 'inherit';
					me._category_2_scroller__vertScrollFg.style.visibility = 'inherit';
					me._category_2_scroller.ggVertScrollVisible = true;
					if (!me._category_2_scroller.ggHorScrollVisible && (contentWidth > offsetWidthWithScale - me._category_2_scroller__vertScrollBg.getBoundingClientRect().width)) {
						me._category_2_scroller__horScrollBg.style.visibility = 'inherit';
						me._category_2_scroller__horScrollFg.style.visibility = 'inherit';
						me._category_2_scroller.ggHorScrollVisible = true;
					}
				} else {
					me._category_2_scroller__vertScrollBg.style.visibility = 'hidden';
					me._category_2_scroller__vertScrollFg.style.visibility = 'hidden';
					me._category_2_scroller.ggVertScrollVisible = false;
				}
				if(me._category_2_scroller.ggHorScrollVisible) {
					me._category_2_scroller.ggAvailableHeight = me._category_2_scroller.clientHeight - 15;
					if (me._category_2_scroller.ggVertScrollVisible) {
						me._category_2_scroller.ggAvailableWidth = me._category_2_scroller.clientWidth - 15;
						me._category_2_scroller.ggAvailableWidthWithScale = me._category_2_scroller.getBoundingClientRect().width - me._category_2_scroller__horScrollBg.getBoundingClientRect().height;
					} else {
						me._category_2_scroller.ggAvailableWidth = me._category_2_scroller.clientWidth;
						me._category_2_scroller.ggAvailableWidthWithScale = me._category_2_scroller.getBoundingClientRect().width;
					}
					me._category_2_scroller__horScrollBg.style.width = me._category_2_scroller.ggAvailableWidth + 'px';
					me._category_2_scroller.ggHPercentVisible = contentWidth != 0 ? me._category_2_scroller.ggAvailableWidthWithScale / contentWidth : 0.0;
					if (me._category_2_scroller.ggHPercentVisible > 1.0) me._category_2_scroller.ggHPercentVisible = 1.0;
					me._category_2_scroller.ggScrollWidth = Math.round(me._category_2_scroller__horScrollBg.offsetWidth * me._category_2_scroller.ggHPercentVisible);
					me._category_2_scroller__horScrollFg.style.width = me._category_2_scroller.ggScrollWidth + 'px';
					me._category_2_scroller.ggScrollPosX = me._category_2_scroller.ggScrollPosXPercent * me._category_2_scroller.ggAvailableWidth;
					me._category_2_scroller.ggScrollPosX = Math.min(me._category_2_scroller.ggScrollPosX, me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth);
					me._category_2_scroller__horScrollFg.style.left = me._category_2_scroller.ggScrollPosX + 'px';
					if (me._category_2_scroller.ggHPercentVisible < 1.0) {
						let percentScrolled = me._category_2_scroller.ggScrollPosX / (me._category_2_scroller__horScrollBg.offsetWidth - me._category_2_scroller__horScrollFg.offsetWidth);
						me._category_2_scroller__content.style.left = -(Math.round((me._category_2_scroller.ggContentWidth * (1.0 - me._category_2_scroller.ggHPercentVisible)) * percentScrolled)) + this.ggContentLeftOffset + 'px';
					}
				} else {
					me._category_2_scroller.ggAvailableHeight = me._category_2_scroller.clientHeight;
					me._category_2_scroller.ggScrollPosX = 0;
					me._category_2_scroller.ggScrollPosXPercent = 0.0;
					me._category_2_scroller__content.style.left = this.ggContentLeftOffset + 'px';
				}
				if(me._category_2_scroller.ggVertScrollVisible) {
					me._category_2_scroller.ggAvailableWidth = me._category_2_scroller.clientWidth - 15;
					if (me._category_2_scroller.ggHorScrollVisible) {
						me._category_2_scroller.ggAvailableHeight = me._category_2_scroller.clientHeight - 15;
						me._category_2_scroller.ggAvailableHeightWithScale = me._category_2_scroller.getBoundingClientRect().height - me._category_2_scroller__vertScrollBg.getBoundingClientRect().width;
						me._category_2_scroller__cornerBg.style.visibility = 'inherit';
					} else {
						me._category_2_scroller.ggAvailableHeight = me._category_2_scroller.clientHeight;
						me._category_2_scroller.ggAvailableHeightWithScale = me._category_2_scroller.getBoundingClientRect().height;
						me._category_2_scroller__cornerBg.style.visibility = 'hidden';
					}
					me._category_2_scroller__vertScrollBg.style.height = me._category_2_scroller.ggAvailableHeight + 'px';
					me._category_2_scroller.ggVPercentVisible = contentHeight != 0 ? me._category_2_scroller.ggAvailableHeightWithScale / contentHeight : 0.0;
					if (me._category_2_scroller.ggVPercentVisible > 1.0) me._category_2_scroller.ggVPercentVisible = 1.0;
					me._category_2_scroller.ggScrollHeight =  Math.round(me._category_2_scroller__vertScrollBg.offsetHeight * me._category_2_scroller.ggVPercentVisible);
					me._category_2_scroller__vertScrollFg.style.height = me._category_2_scroller.ggScrollHeight + 'px';
					me._category_2_scroller.ggScrollPosY = me._category_2_scroller.ggScrollPosYPercent * me._category_2_scroller.ggAvailableHeight;
					me._category_2_scroller.ggScrollPosY = Math.min(me._category_2_scroller.ggScrollPosY, me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight);
					me._category_2_scroller__vertScrollFg.style.top = me._category_2_scroller.ggScrollPosY + 'px';
					if (me._category_2_scroller.ggVPercentVisible < 1.0) {
						let percentScrolled = me._category_2_scroller.ggScrollPosY / (me._category_2_scroller__vertScrollBg.offsetHeight - me._category_2_scroller__vertScrollFg.offsetHeight);
						me._category_2_scroller__content.style.top = -(Math.round((me._category_2_scroller.ggContentHeight * (1.0 - me._category_2_scroller.ggVPercentVisible)) * percentScrolled)) + me._category_2_scroller.ggContentTopOffset + 'px';
					}
				} else {
					...
					me._category_2_scroller.ggScrollPosY = 0;
					me._category_2_scroller.ggScrollPosYPercent = 0.0;
					me._category_2_scroller__content.style.top = this.ggContentTopOffset + 'px';
					me._category_2_scroller__cornerBg.style.visibility = 'hidden';
				}
				if(horScrollWasVisible != me._category_2_scroller.ggHorScrollVisible || vertScrollWasVisible != me._category_2_scroller.ggVertScrollVisible) {
					skin.updateSize(me._category_2_scroller);
					me._category_2_scroller.ggUpdatePosition();
				}
			}
		}
		el=me._category_2_cloner=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._category_2_cloner;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		el.ggUpdate = function(filter) {
			if(me._category_2_cloner.ggUpdating == true) return;
			me._category_2_cloner.ggUpdating = true;
			var el=me._category_2_cloner;
			var curNumCols = 0;
			curNumCols = me._category_2_cloner.ggNumRepeat;
			if (curNumCols < 1) curNumCols = 1;
			if (typeof filter=='object') {
				el.ggFilter = filter;
			} else {
			...
			filter=filter.sort();
			if ((el.ggNumCols == curNumCols) && !el.ggSizeChanged && (el.ggInstances.length > 0) && (filter.length === el.ggCurrentFilter.length) && (filter.every(function(value, index) { return value === el.ggCurrentFilter[index] }) )) {
				me._category_2_cloner.ggUpdating = false;
				return;
			} else {
				el.ggSizeChanged = false;
				el.ggNumRows = 1;
			...
			var centerOffsetHor = 0;
			var centerOffsetVert = 0;
				me._category_2_cloner.ggCloneOffsetChanged = false;
			}
			el.ggCurrentFilter = filter;
			el.ggInstances = [];
			if (el.hasChildNodes() == true) {
			...
			var currentIndex = 0;
			var keepCloning = true;
			me._category_2_cloner.ggNumFilterPassed = 0;
			var firstNode;
			for (var i = 0; i < el.ggTagTable.length; i++) {
				...
				me._category_2_cloner.ggNumFilterPassed++;
				var nodeId = {};
				...
				if (!keepCloning || i < me._category_2_cloner.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me._category_2_cloner.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me._category_2_cloner.ggWidth) + 'px';
				parameter.width=me._category_2_cloner.ggWidth + 'px';
				parameter.height=me._category_2_cloner.ggHeight + 'px';
				parameter.index=currentIndex;
				var inst = new SkinCloner_category_2_cloner_Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me._category_2_cloner.ggNodeCount = me._category_2_cloner.ggNumFilterPassed;
			me._category_2_cloner.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me._category_2_cloner.parentNode && me._category_2_cloner.parentNode.classList.contains('ggskin_subelement') && me._category_2_cloner.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me._category_2_cloner.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"",title:"All",description:""},
			];
		el.ggId="category_2_cloner";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_cloner ";
		el.ggType='cloner';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._category_2_cloner.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._category_2_cloner.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me._category_2_cloner.childNodes.length; i++) {
				var child=me._category_2_cloner.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
		...
		me._category_2_cloner.ggUpdatePosition=function (useTransition) {
			me._category_2_cloner.ggUpdate();
		}
		me._category_2_scroller__content.appendChild(me._category_2_cloner);
		me._menu_background.appendChild(me._category_2_scroller);
		...
		me._category_scroller.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('menu_cloner') == Number("0")))
			)
			{
				newLogicStateAlpha = 0;
			}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		player.addListener('activehotspotchanged', function(event) {
			for(var i = 0; i < me._node_cloner0.ggInstances.length; i++) {
				me._node_cloner0.ggInstances[i].ggEvent_activehotspotchanged(event);
			}
		...
		player.addListener('changenode', function(event) {
			...
			for(var i = 0; i < me._category_2_cloner.ggInstances.length; i++) {
				me._category_2_cloner.ggInstances[i].ggEvent_changenode(event);
			}
			for(var i = 0; i < me._node_cloner0.ggInstances.length; i++) {
				me._node_cloner0.ggInstances[i].ggEvent_changenode(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
			...
			me._category_2_scroller.logicBlock_alpha();
			me._category_2_cloner.ggUpdateConditionNodeChange();
			me._category_scroller.logicBlock_alpha();
		...
		player.addListener('changevisitednodes', function(event) {
			for(var i = 0; i < me._node_cloner0.ggInstances.length; i++) {
				me._node_cloner0.ggInstances[i].ggEvent_changevisitednodes(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
		...
		player.addListener('configloaded', function(event) {
			for(var i = 0; i < me._node_cloner0.ggInstances.length; i++) {
				me._node_cloner0.ggInstances[i].ggEvent_configloaded(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
		...
		player.addListener('varchanged_menu_cloner', function(event) {
			me._node_scroller.logicBlock_alpha();
			me._category_2_scroller.logicBlock_alpha();
			me._category_scroller.logicBlock_alpha();
		});
		player.addListener('varchanged_menu_open', function(event) {
			me._menu_background.logicBlock_alpha();
		});
	...
	function SkinCloner_categories_cloner_Class(item, parentScope, ggParent, parameter) {
		...
		me._category_thumbnail.onclick=function (e) {
			...
			skin._node_cloner0.ggText=me.ggTag;
			if (skin._node_cloner0.ggText=='') {
				skin._node_cloner0.ggUpdate([]);
			} else {
				skin._node_cloner0.ggUpdate(skin._node_cloner0.ggText.split(','));
			}
	...
	function SkinCloner_category_cloner_Class(item, parentScope, ggParent, parameter) {
		...
		me._category_text.logicBlock_textcolor = function() {
			...
			if (me._category_text.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				me._category_text.style.transition='color 0s';
				if (me._category_text.ggCurrentLogicStateTextColor == 0) {
					me._category_text.style.color="rgba(255,255,255,1)";
				}
				else {
					me._category_text.style.color="rgba(209,209,209,1)";
				}
			}
		}
		...
		me._category_text.onclick=function (e) {
			...
			skin._category_2_cloner.ggText=me.ggTag;
			if (skin._category_2_cloner.ggText=='') {
				skin._category_2_cloner.ggUpdate([]);
			} else {
				skin._category_2_cloner.ggUpdate(skin._category_2_cloner.ggText.split(','));
			}
			skin.updateSize(skin.divSkin);
			player.setVariableValue('category_var', me.ggTag);
			player.setVariableValue('menu_cloner', Number("1"));
		}
	...
	function SkinCloner_category_2_cloner_Class(item, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		el=me._category_2_text=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._category_2_text;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._category_2_text__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="category_2_text";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._category_2_text.ggUpdateText=function() {
			var params = [];
			params.push(player._(String(me.ggTitle)));
		...
		me._category_2_text.ggUpdateText();
		player.addListener('clonerchanged', function() {
			me._category_2_text.ggUpdateText();
		});
		el.appendChild(els);
		me._category_2_text.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._category_2_text.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				((me._category_2_text.ggIsActive() == true))
			)
			{
				newLogicStateTextColor = 0;
			}
			...
			if (me._category_2_text.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._category_2_text.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._category_2_text.style.transition='color 0s';
				if (me._category_2_text.ggCurrentLogicStateTextColor == 0) {
					me._category_2_text.style.color="rgba(255,255,255,1)";
				}
				else {
					me._category_2_text.style.color="rgba(209,209,209,1)";
				}
			}
		}
		me._category_2_text.logicBlock_textcolor();
		me._category_2_text.onclick=function (e) {
			if (me._category_2_text.isDragging()) return;
			skin._node_cloner0.ggText=me.ggTag+","+player.getVariableValue('category_var', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : ''));
			if (skin._node_cloner0.ggText=='') {
				skin._node_cloner0.ggUpdate([]);
			} else {
				skin._node_cloner0.ggUpdate(skin._node_cloner0.ggText.split(','));
			...
			skin.updateSize(skin.divSkin);
			player.setVariableValue('menu_cloner', Number("2"));
		}
		me._category_2_text.ggActivate=function () {
			if (
				(
					((player.getVariableValue('menu_cloner') == Number("2")))
				)
		...
		me._category_2_text.ggUpdatePosition=function (useTransition) {
		}
		me.__div.appendChild(me._category_2_text);
		me._category_2_text.logicBlock_textcolor();
			me.ggEvent_changenode=function(event) {
				me._category_2_text.logicBlock_textcolor();
				if (me._category_2_text.ggLastIsActive!=me._category_2_text.ggIsActive()) {
					me._category_2_text.ggLastIsActive=me._category_2_text.ggIsActive();
					if (me._category_2_text.ggIsActive()) {
						if (me._category_2_text.ggActivate) me._category_2_text.ggActivate();
					} else {
						if (me._category_2_text.ggDeactivate) me._category_2_text.ggDeactivate();
					}
				}
			};
	};
	function SkinCloner_node_cloner0_Class(nodeId, parentScope, ggParent, parameter) {
		...
		me._node_image_cloner.onclick=function (e) {
			...
			if (
				(
					((player.getVariableValue('menu_touch') == true)) && 
					((player.getHasTouch() == true))
				)
			) {
				if (player.transitionsDisabled) {
					skin._menu_background.style.transition='none';
				} else {
					skin._menu_background.style.transition='all 500ms ease-out 0ms';
				}
				skin._menu_background.style.opacity='0';
				skin._menu_background.style.visibility='hidden';
			}
			if (
				(
					((player.getVariableValue('menu_touch') == true)) && 
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
